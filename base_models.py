...
#----------------------------------------------------------------------------------------------------------
# Code for LSiM base net adapted from:
# Kohl et al. Learning Similarity Metrics for Numerical Simulations (2020)
# at https://github.com/tum-pbs/LSIM
#----------------------------------------------------------------------------------------------------------
...
#----------------------------------------------------------------------------------------------------------
# Code for Squeeze, Vgg and Alex adapted from:
